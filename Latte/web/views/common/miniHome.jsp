...
<body onresize="parent.resizeTo(1320,800)" onload="parent.resizeTo(1320,800)" style="overflow-x:hidden; overflow-y:hidden;">
	<div id = "miniHome">
	<div id = "visitCheck" style = "height : 30px"><label id = "todayVisitCount">오늘의 방문자</label> / <label id = "totalVisitCount">총 방문자</label></div>
	<div id = "miniTitle" style = "height : 50px"><%= userName %> 미니홈피</div>
		<div id = "miniLeft" class = "mini2nd">
			...
			<div id = "ownerInfo">개인 정보<br>이름 : 김라떼<br>나이 : 20대 중반<br>이상형 : 현모양처<br>특기 : 개드립<br>방문자에게 하고싶은 말<br> : 볼 건 없지만 재밌게 보다 가세요!<br>방명록 / 일촌평은 쎈쓰!!!!</div>
		</div>
		
		<div id = "miniCenter" class = "mini2nd">
			<div id = "miniHomeImg">미니 홈페이지 꾸며놓은거 가져다 놓기</div>
			<div id = "relativeComments">일촌들이 글 싸지르는 공간</div>
			<div id = "latteWave" style = "float : right">
