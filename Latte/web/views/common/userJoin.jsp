...
<!-- 메인 탑 메뉴 -->
	<div id = "mainTop">
		<div id = "topLogo">
			<image id = "mainLogo" width = "100px" height = "100px" src="../images/MainLogo.jpg" onclick = "location.href ='${contextPath}/views/common/mainPage.jsp'">
		</div>
		<div id = "topMenu">
			<span><a>미니홈피</a></span>
			<span><a>선물가게</a></span>
	...
	function checkForm(){
            ...
            $("#registerForm").attr("action","<%=request.getContextPath() %>/registerUserServlet").submit();
            return true; //전송 처리
        };
